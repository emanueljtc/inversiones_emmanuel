 ...
 <div class="panel panel-primary">
        ...
        <div class="control-label col-xs-10">
					 ...
					 <div class="col-xs-7">
						 ...
						 'label'=>'','placeholder' => 'Edad','type'=>'text','class'=>'form-control','onkeypress'=>'return IsEdad(event);','maxlength'=>'3','readonly'=>'readonly','onClick'=>'calcularEdad();','id'=>'edad'
							 )); ?>
					 </div>
					 ...
					 <div class="col-xs-7">
							 ...
							 'label'=>'','placeholder' => 'Telefono Celular','type'=>'text','class'=>'form-control','onkeypress'=>'return IsTelefono(event);','maxlength'=>'11'
								 )); ?>
					 </div>
					 <label class="control-label col-xs-3" >Telefono:</label>
					 <div class="col-xs-7">
							 <?php echo $this->Form->input('phone', array(
							 'label'=>'','placeholder' => 'Telefono Local','type'=>'text','class'=>'form-control','onkeypress'=>'return IsTelefono(event);','maxlength'=>'11'
								 )); ?>
					 </div>
