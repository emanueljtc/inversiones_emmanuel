...
<?php echo $this->Form->create('Wake'); ?>
	<fieldset>
		<legend><?php echo __('Edit Wake'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Wake.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Wake.id')))); ?></li>
